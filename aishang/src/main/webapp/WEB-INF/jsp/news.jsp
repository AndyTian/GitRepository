...
<p style="color:hsl(340, 100%, 30%) !important;font-weight:bold;">Acesomodel@163.com</p>
    ...
    <!--left begin-->
    <div class="news-left-container" style="">
        <div class="news-head">
...
$.getJSON("content/getschoollifebyid",{id:key},function(result){
    var newtitle='';
    var newdate='';
    var newscontent='';
   newtitle = result.title;
   /* alert(newtitle);*/
  newdate='本文发表于<b>'+AS.formatDateTime(result.created,0)+'</b>'
   newcontent=result.content;
   $('.new-name').html(newtitle);
   $('.c-1').html(newcontent);
