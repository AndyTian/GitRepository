...
<div style="padding:10px 10px 10px 10px">
	...
	<div style="padding:5px">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="courseAddPage.submitForm()">提交</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="courseAddPage.clearForm()">重置</a>
	</div>
</div>
...
$(function(){
	AS.initOnePicUpload();
	//创建富文本编辑器
	courseAddEditor = AISHANG.createEditor("#courseAddForm [name=summary]");
});
	var courseAddPage  = {
			submitForm : function (){
				...
				$.post("/manage/course/save",$("#courseAddForm").serialize(), function(data){
					if(data.status == 200){
