...
<html>
  ...
  <link rel="shortcut icon" href="images/favicon.ico" />
	...
	<link href="css/picturestyle.css" rel="stylesheet" type="text/css" />
...
$.getJSON("content/getschoolpic",{},function(data){
        ...
        if(i%7==0){
         str+='<div> <a href="'+data[i].pic+'" target="_blank"><img src="'+data[i].pic+'"/></a><p class="pi">Aceso Culture & Art School</p></div>';
        }else{
         str+='<div><a href="'+data[i].pic+'" target="_blank"> <img src="'+data[i].pic+'"/></a></div>';
        }
  
        }

        $('.pic-container').html(str);
        });
</script>
  <!--start-footer-->
  <div class="footer">
