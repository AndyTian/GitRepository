...
<div class="container">
    ...
    <script>
     ...
     function getUrlParam(name) {
        ...
        var key = getUrlParam("pic");
        
        
        $(document).ready(function(){
  
         $.getJSON("/content/getstudentbyid",{id:key},function(result){
                   
                   strName='<span class="modelbeader">';
                   strContent='<div class="mol-con">';
                   var  name='';
                   var content='';
                   var pic1='<img src="'+result.pic1+'"/>';
                
                  
                   var pic2='<div class="news-label"><span>个人作品</span><div></div></div>';
         
                   name = result.name;
                   strName+=name+'</span>';
                   content=result.summary;
                   strContent+=content+'</div>';
                   strName+=strContent;
                   pic2+='<img class="img-style" src="'+result.pic2+'"/><img class="img-style" src="'+result.pic3+'"/>';

                   $(".news-content").html(pic2);
                   $(".model-box").html(pic1);
                   
                   $(".model-introduce").html(strName);
