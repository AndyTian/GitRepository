...
<body  style="min-width:542px;position:relative;" >
<div class="f-logo">
...
<p style="color:hsl(340, 100%, 30%) !important;font-weight:bold;">Acesomodel@163.com</p>
    ...
    <div class="people-introduction" >
        <div class="introduce-header">
           <h2 style="height: 40px;display: block;border-bottom: 2px solid #829bb3;">艾尚师资</h2>
        </div>
        <div id="teacher">
    ...
    <script>
            ...
            $(function() {
		$.getJSON("/content/teacher",{},function(data){
			var str='';
			for(i=0;i<data.length; i++){
				 str+='<div class="each-people"><div class="people-photo"><img src="'+data[i].pic+'"></div><div class="people-content"><div class="people-name"> <h6>'+data[i].name+'</h6></div><div>'+data[i].summary+'</div></div></div>';
			}
			var str1='<div style="width:0;height:0;clear:both;"></div>';
			$('#teacher').html(str);
		}) 
	});
    </script>
