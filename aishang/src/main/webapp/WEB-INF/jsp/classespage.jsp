...
<p style="color:hsl(340, 100%, 30%) !important;font-weight:bold;">Acesomodel@163.com</p>
	...
	$(function() {
		$.getJSON("/content/getcourses",{},function(data){
			...
			str+='<li><a class="image-box" href="classesintroduce?s='+data[i].id+'"><img class="img-1"  src="'+data[i].pic+'"/></a><h3>'+data[i].name+'</h3><p><span>学期：'+data[i].term+'个月</span>&nbsp;|&nbsp;<span>学费：'+data[i].cost+'</span>&nbsp;|&nbsp;<span>火热报名中!</span></p><span class="btu"><a class="btua"  href="classesintroduce?s='+data[i].id+'">课程详情</a></span></li>';
